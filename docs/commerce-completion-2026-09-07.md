...
2. Actual Kerala serviceable PIN codes, freight and arrival windows, and the remaining claims/returns/refund terms. The Hardwood damage/shortage input is settled at within 24 hours of delivery with photos; inspection/collection, remedy, after-dispatch returns and refund-initiation timing remain pending. The commercial review is in `docs/commerce-launch-review.md`.
