...
On 8 September, the owner approved archived source `cwi_wa_482_938x1280.jpg` (`9115bc38f8524cdf217136b834634c98cef1c7b4ee5c2a529c95902d8a6cb1df`) as a shared representative Premium Hardwood family photograph and requested a sales-oriented edit. The returned PNG (`955a7a9fccee7b5fe47c9d55cca19d591d376aa8f1d7b09069db6461d8b72487`) is recorded as an AI-edited family presentation in [the evidence receipt](premium-hardwood-photo-evidence-2026-09-08.md). It is not an untouched documentary photo, does not distinguish 12 mm from 18 mm, and cannot support claims based on generated layers or edges. It has no project asset path or public URL. The exact-photo and image-approval fields remain gated, so this record does not activate the catalogue, purchase flow or Merchant export.
...
| Product imagery | Owner-approved original and AI-edited presentation recorded as one shared Premium Hardwood family image, with exact hashes and commercial-use approval scope | Evidence only. Copy reviewed bytes into the consuming project before use; then complete product-level and publication review. It is not thickness-specific proof, and current exact-photo/approval fields remain unset. |
