# Website improvement checklist — 13 September 2026
...
| 5 | Mobile speed and accessibility | Existing release checks cover responsive layouts, keyboard paths, form labels, consent and reduced motion. A fresh representative performance/accessibility pass is queued for the candidate. | Run representative mobile and desktop checks; fix only measured defects. |
| 6 | Product comparison | Implemented a concise catalogue comparison with applications, bond/grade, core/surface, thickness choices, limitations and a CSP-safe print action. | Build, site checks, browser layout check and printed-view inspection. |
| 7 | Measure commercial results | Existing CWI search and enquiry results monitor remains the only monitor and retains the documented transition-date exclusions and reporting windows. | Update the monitor with this release date after publication; future results require complete periods and equal follow-up time. |
