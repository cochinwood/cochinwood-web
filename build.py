...
<section class="cw-sec" id="quote"><div class="cw-wrap" style="max-width:820px">
  ...
  <div class="cw-sales-team" id="cw-sales-section">
    <style>
      #cw-sales-section {{
        margin-top: 36px;
      ...
      function draw() {{
        ...
        if (!rows.length) {{
          list.innerHTML = '<div style="grid-column:1/-1;text-align:center;padding:24px 12px;color:#64748b;font-size:.88rem;background:#f8fafc;border:1px dashed #cbd5e1;border-radius:10px">' +
            'No sales managers match this filter. Please call our general sales desk at <a href="tel:{CONTACT["phone_href"]}" style="color:#1b4d3e;font-weight:700;text-decoration:underline">{CONTACT["phone_disp"]}</a>.</div>';
          return;
        }}
