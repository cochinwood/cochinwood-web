...
Before payable offers, confirm the company prices, tax, stock handling, product specifications and exact-product photographs, delivery eligibility/timing and operating terms. The app-rate-plus-₹20/sq.ft proposal gives the two Hardwood sheets at ₹2,368 / ₹2,720 per nominal 8 × 4 ft before GST/freight; those remain review amounts and have not been inserted into this configuration. Commercial remains excluded and Marine remains held.
